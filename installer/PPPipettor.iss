...
AppCopyright=Copyright©IinkautoBiology 2014-2020
VersionInfoVersion={#MyAppVersion}
VersionInfoCompany=InkautoBiology
AppPublisher=InkautoBiology
...
[Icons]
Name: "{group}\Pipettor"; Filename: "{app}\bin\Pipettor"
Name: "{group}\{cm:UninstallProgram,MyProgram}"; Filename: "{uninstallexe}"
Name: "{commondesktop}\Pipettor"; Filename: "{app}\bins\Pipettor"; Tasks: desktopicon
Name: "{userappdata}\Microsoft\Internet Explorer\Quick Launch\Pipettor"; Filename: "{app}\bins\Pipettor.exe"; Tasks: quicklaunchicon

[Run]
Filename: "{app}\bins\Pipettor.exe"; Description: "{cm:LaunchProgram,Pipettor}"; Flags: nowait postinstall skipifsilent

[Registry]
Root: HKLM; Subkey: Software\Pipettor; ValueType: string; ValueName: InstallPath; ValueData: {app}
